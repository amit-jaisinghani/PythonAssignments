...
class Kebab:
    ...
    def usage(self):
        ...
        print("add item - adds an item to the skewer")  # push
        ...
        print("eat - eat the front item on the skewer")  # pop
        print("foods - display the food items that can be added to the skewer")
        print("front - the front item on the skewer")  # peek
        print("has item - is an item on the skewer?")  # is empty
        print("quit - exit the program")
        print("status - the capacity and current number of items on the skewer")  # size
        print("vegan - does the skewer have any meat?")  # is_veggie
        print("calories - get the total number of calories of items on the skewer")  # total_calories
    ...
    def calories(self, args):
        """
        Display the total calories count of food items on the skewer.
        :param args: ignored
        :return: None
        """

        try:
            print("The skewer has ", self.skewer.total_calorie_count(), " calories.")
        except SkewerException as e:
            print(e)
